...
Func _BASS_EXT_ChannelGetFFT($hHandle, $aFFT, $iFallOff = 6, $bUseMixer = False)
	...
	Switch $bUseMixer
		Case False
			Local $iBytes = _BASS_ChannelGetData($hHandle, $pFFT, $BASS_DATA_FFT8192)
			If @error Or Not $iBytes Then Return SetError(1, 1, 0)
		Case Else
			Local $sCall = "_BASS_Mixer_ChannelGetData"
			Local $iBytes = Call($sCall, $hHandle, $pFFT, $BASS_DATA_FFT8192)
...
; Syntax.........: Func _BASS_EXT_Level2dB($fLevel, $bFlag = True)
...
; Syntax.........: Func _BASS_EXT_dB2Level($fdB, $bFlag = True)
...
; #FUNCTION# ====================================================================================================================
; Name...........: Func _BASS_EXT_WaveformSetWidth
; Description ...: sets new width of the waveform polygon
; Syntax.........: Func _BASS_EXT_WaveformSetWidth(ByRef $aWave, $iWidth)
...
; #FUNCTION# ====================================================================================================================
; Name...........: Func _BASS_EXT_GDIpBitmapCreateWaveform
; Description ...: Creates a gdiplus bitmap with the waveform polygon created by _BASS_EXT_ChannelGetWaveformDecode
; Syntax.........: Func _BASS_EXT_GDIpBitmapCreateWaveform($hGraphics, $aWave, $hBrushL, $hPenL, $hBrushR = 0, $hPenR = 0, $iBKColor = 0, $iSmooth = 0)
...
; #FUNCTION# ====================================================================================================================
; Name...........: Func _BASS_EXT_ChannelGetWaveformDecode
; Description ...: Creates a waveform polygon of a decoding channel
; Syntax.........: Func _BASS_EXT_ChannelGetWaveformDecode($hHandle, $iWidth, $iHeight, $fStartSec = 0, $fEndSec = 0, $iNodesPerSeconds = 88, $Proc = 0)
